...
abstract: "Multiple notable economic events have occurred both globally and within the United States have occurred between the time of the last two rounds of the US GSS in 2018 and 2021. Within the GSS we investigate topics relating to economic well-being during those periods, specifically changes and satisfaction with personal and family financial situations, perception of income and standard of living. We find a trend of worse economic well-being, decreased belief in improvement of standard of living, and growing financial dissatisfaction especially among younger adults. We hypothesize that this aligns with the increase in popularity of work reform movements in the United States. To establish a greater correlation, we devise a supplemental survey for the GSS exploring sentiments towards work."
output:
